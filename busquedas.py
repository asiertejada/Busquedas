...
# set locale to translate dates to Spanish
...
fill(0)
stroke(None)
textBox("Búsquedas " + year, (width()/2+80, height()/2, 200, 10))
printGuides()
...
while overflow_txt:
    ...
    if p == 1:
        ...
        fill(0)
        textBox("BÚSQUEDAS", (width() - margin_title_w, height() - margin_title_h, 40, 10), align="right")
...
textBox("Año:", (summary_x+shift, summary_y+15, 200, 10))
textBox(year, (summary_x+100+shift, summary_y+15, 250, 10))

textBox("Total de búsquedas:", (summary_x+shift, summary_y, 200, 10))
textBox(str(validSearches), (summary_x+100+shift, summary_y, 250, 10))

textBox("Media mensual:", (summary_x+shift, summary_y-15, 200, 10))
textBox(str(round(validSearches/12,1)), (summary_x+100+shift, summary_y-15, 250, 10))

textBox("Media diaria:", (summary_x+shift, summary_y-30, 200, 10))
textBox(str(round(validSearches/365,1)), (summary_x+100+shift, summary_y-30, 250, 10))

textBox("Búsquedas cada mes:", (summary_x+shift, summary_y-45, 200, 10))
for i in range(0, 12):
...
fontSize(summary_size)
lineHeight(10)
textBox("Este libro ha sido generado con DrawBot, drawbot.com\n Un proyecto de Ishac Bertrán, ishback.com", (100 + shift, 50, width()-200, 40), align="center")
printGuides()
